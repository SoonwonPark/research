...
class Analysis:
    ...
    def link_subgraph(self):
        ...
        newgraph.write('CFG-example.dot')
...
def main():
    ...
    myAnalysis.make_flowchart("CreatePipe")
    myAnalysis.make_flowchart("GetStartupInfoA")
    myAnalysis.make_flowchart("CreateProcessA")
    myAnalysis.make_flowchart("CloseHandle")
    myAnalysis.make_flowchart("SetNamedPipeHandleState")
    myAnalysis.make_flowchart("Sleep")
    myAnalysis.make_flowchart("GetExitCodeProcess")
    myAnalysis.make_flowchart("sub_4031C0")
    myAnalysis.make_flowchart("ReadFile")
    myAnalysis.make_flowchart("GetExitCodeProcess")
    myAnalysis.make_flowchart("sub_401538")
    myAnalysis.make_flowchart("TerminateProcess")
